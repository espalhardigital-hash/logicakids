...
* **Amplificación:** Multiplicar numerador y denominador por el mismo número para obtener una fracción equivalente con más partes.
* **Equivalencia:** Fracciones con diferentes términos numéricos que representan exactamente la misma porción del todo.
...
* **Ejemplo 1: \(\frac{1}{3} = \frac{4}{12}\) (Multiplicar por 4)**
  * *Paso 1:* La figura original tiene 3 columnas y 1 coloreada (1/3).
  * *Paso 2:* Cortamos cada columna por la mitad y trazamos diagonales para obtener 12 partes en total (3 × 4 = 12).
  * *Paso 3:* Para mantener la misma porción pintada, ahora coloreamos 4 partes pequeñas (1 × 4 = 4).
  * *Resultado:* 1/3 = 4/12.

* **Ejemplo 2: \(\frac{1}{2} = \frac{8}{16}\) (Patrón de Diamantes)**
  * *Paso 1:* Dividimos la figura usando líneas horizontales, verticales y diagonales de diamantes en 16 partes iguales.
  * *Paso 2:* Contamos la parte coloreada de turquesa: los dos rombos centrales suman 8 triángulos.
  * *Paso 3:* 8 partes de 16 cubren exactamente la mitad del área del cuadrado.
  * *Resultado:* 1/2 = 8/16.

* **Ejemplo 3: \(\frac{3}{8} = \frac{6}{16}\) (Multiplicar por 2)**
  * *Paso 1:* La cuadrícula izquierda tiene 8 rectángulos y 3 están coloreados (3/8).
  * *Paso 2:* Al dividir cada rectángulo diagonalmente en 2 partes iguales, duplicamos el total de piezas: 8 × 2 = 16.
  * *Paso 3:* Los 3 rectángulos turquesas ahora representan 6 triángulos coloreados (3 × 2 = 6).
  * *Resultado:* 3/8 = 6/16.

* **Ejemplo 4: \(\frac{1}{2} = \frac{6}{12}\) (Hexágono Molinillo)**
  * *Paso 1:* El hexágono regular está dividido en 12 triángulos iguales.
  * *Paso 2:* Identificamos 6 aspas amarillas formando un patrón de molinillo.
  * *Paso 3:* 6 de 12 representa la mitad exacta de las porciones totales.
  * *Resultado:* 1/2 = 6/12.
