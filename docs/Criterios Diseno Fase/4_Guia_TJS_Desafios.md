...
Los valores de volumetría de siembra son los mismos que fija el Tomo 1 §11 para toda la plataforma:

| Tipo de batería | Familias por nivel | Preguntas por familia | Total sembrado por nivel | El niño responde |
|---|---|---|---|---|
| **Práctica libre** | 120 | 4 (1 original + 3 espejo) | **480** | **15** (`cantidad_requerida`) |
