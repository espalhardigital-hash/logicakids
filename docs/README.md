...
| **Progresión de práctica: 10 aciertos** | [`docs/CONTRATO_PROGRESION_PRACTICA.md`](./CONTRATO_PROGRESION_PRACTICA.md) | **Normativo.** Contador visible, cierre y datos comparten una sola meta; prevalece sobre referencias históricas a 15/50 preguntas o familias distintas |
...
| **Integración de referencias matemáticas (Fases 5–7)** | [`docs/INTEGRACION_REFERENCIAS_MATEMATICAS_FASES_5_7.md`](./INTEGRACION_REFERENCIAS_MATEMATICAS_FASES_5_7.md) | Familias nuevas, coherencia gráfica y evidencia local de pruebas |
