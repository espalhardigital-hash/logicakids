...
from .schemas import (
    ...
    Fase5ResponderPregunta, Fase5ResultadoRespuesta,
...
async def get_fase5_dashboard(
    ...
    result = await db.execute(
        select(ConfiguracionProgreso).where(ConfiguracionProgreso.fase_id == FASE5_ID)
    )
