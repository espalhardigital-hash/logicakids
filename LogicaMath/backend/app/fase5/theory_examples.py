        ...
        (1, 1): [
            {
                "enunciado": "Calcula el perímetro de esta figura contando cada segmento del contorno en la cuadrícula:<br/>"
                             ...
                             "  <text x='60' y='67' fill='#FFF' font-family='sans-serif' font-size='14' font-weight='bold' text-anchor='middle'>2x2</text>"
                             "</svg>",
                "pasos": [
            ...
            },
            {
                "enunciado": "El perímetro de un triángulo con lados de 6 cm cada uno es:<br/>"
                             ...
                             "  <text x='60' y='140' fill='#FFF' font-size='22' font-weight='bold' text-anchor='middle'>6 cm</text>"
        ...
        (2, 2): [
            {
                "enunciado": "Calcula el área total de la figura sumando cuadrados completos y mitades (triángulos):<br/>"
                             "<svg width='260' height='260' viewBox='0 0 120 120' style='margin:10px auto; display:block; background:#111827; border:1px solid #374151; border-radius:12px;'>"
                             "  <path d='M20,0 V120 M40,0 V120 M60,0 V120 M80,0 V120 M100,0 V120 M0,20 H120 M0,40 H120 M0,60 H120 M0,80 H120 M0,100 H120' stroke='#1F2937' stroke-width='0.4'/>"
                             "  <!-- 2 cuadrados y 2 triángulos (mitades) -->"
                             "  <rect x='40' y='40' width='40' height='20' fill='#3B82F6' fill-opacity='0.3' stroke='#3B82F6' stroke-width='1.2'/>"
                             "  <polygon points='80,40 100,40 80,60' fill='#3B82F6' fill-opacity='0.3' stroke='#3B82F6' stroke-width='1.0'/>"
                             "  <polygon points='80,60 100,60 80,40' fill='#3B82F6' fill-opacity='0.1' stroke='#3B82F6' stroke-width='1.0'/>"
                             "</svg>",
                "pasos": [
            ...
            },
            {
                "enunciado": "Si tengo 4 cuadrados enteros y 2 mitades. ¿Cuál es el área total?<br/>"
                             "<svg width='260' height='260' viewBox='0 0 120 120' style='margin:10px auto; display:block; background:#111827; border:1px solid #374151; border-radius:12px;'>"
                             "  <path d='M20,0 V120 M40,0 V120 M60,0 V120 M80,0 V120 M100,0 V120 M0,20 H120 M0,40 H120 M0,60 H120 M0,80 H120 M0,100 H120' stroke='#1F2937' stroke-width='0.4'/>"
                             "  <rect x='20' y='40' width='80' height='20' fill='#3B82F6' fill-opacity='0.3' stroke='#3B82F6' stroke-width='1.2'/>"
                             "  <polygon points='100,40 120,40 100,60' fill='#3B82F6' fill-opacity='0.3' stroke='#3B82F6' stroke-width='1.0'/>"
                             "  <polygon points='100,60 120,60 100,40' fill='#3B82F6' fill-opacity='0.1' stroke='#3B82F6' stroke-width='1.0'/>"
                             "</svg>",
                "pasos": [
            ...
            },
            {
                "enunciado": "Una figura geométrica tiene 0 cuadrados enteros y 4 mitades triangulares. Su área es:<br/>"
                             "<svg width='260' height='260' viewBox='0 0 120 120' style='margin:10px auto; display:block; background:#111827; border:1px solid #374151; border-radius:12px;'>"
                             "  <path d='M20,0 V120 M40,0 V120 M60,0 V120 M80,0 V120 M100,0 V120 M0,20 H120 M0,40 H120 M0,60 H120 M0,80 H120 M0,100 H120' stroke='#1F2937' stroke-width='0.4'/>"
                             "  <polygon points='20,20 40,20 20,40' fill='#3B82F6' fill-opacity='0.3' stroke='#3B82F6' stroke-width='1.0'/>"
                             "  <polygon points='40,20 60,20 40,40' fill='#3B82F6' fill-opacity='0.3' stroke='#3B82F6' stroke-width='1.0'/>"
                             "  <polygon points='60,20 80,20 60,40' fill='#3B82F6' fill-opacity='0.3' stroke='#3B82F6' stroke-width='1.0'/>"
                             "  <polygon points='80,20 100,20 80,40' fill='#3B82F6' fill-opacity='0.3' stroke='#3B82F6' stroke-width='1.0'/>"
                             "</svg>",
                "pasos": [
            ...
            },
            {
                "enunciado": "Si tengo 10 enteros y 6 mitades, ¿cuál es el área total?<br/>"
                             "<svg width='260' height='260' viewBox='0 0 120 120' style='margin:10px auto; display:block; background:#111827; border:1px solid #374151; border-radius:12px;'>"
                             "  <path d='M20,0 V120 M40,0 V120 M60,0 V120 M80,0 V120 M100,0 V120 M0,20 H120 M0,40 H120 M0,60 H120 M0,80 H120 M0,100 H120' stroke='#1F2937' stroke-width='0.4'/>"
                             "  <rect x='10' y='40' width='100' height='40' fill='#3B82F6' fill-opacity='0.3' stroke='#3B82F6' stroke-width='1.2'/>"
                             "  <polygon points='10,40 30,40 30,20' fill='#3B82F6' fill-opacity='0.2' stroke='#3B82F6' stroke-width='1.0'/>"
                             "  <polygon points='30,40 50,40 50,20' fill='#3B82F6' fill-opacity='0.2' stroke='#3B82F6' stroke-width='1.0'/>"
                             "  <polygon points='50,40 70,40 70,20' fill='#3B82F6' fill-opacity='0.2' stroke='#3B82F6' stroke-width='1.0'/>"
                             "  <polygon points='70,40 90,40 90,20' fill='#3B82F6' fill-opacity='0.2' stroke='#3B82F6' stroke-width='1.0'/>"
                             "  <polygon points='90,40 110,40 110,20' fill='#3B82F6' fill-opacity='0.2' stroke='#3B82F6' stroke-width='1.0'/>"
                             "  <polygon points='10,80 30,80 30,100' fill='#3B82F6' fill-opacity='0.2' stroke='#3B82F6' stroke-width='1.0'/>"
                             "</svg>",
                "pasos": [
        ...
        (2, 3): [
            ...
            },
            {
                "enunciado": "¿Cuánto es 8 enteros más 8 mitades?<br/>"
                             "<svg width='260' height='260' viewBox='-15 -10 150 135' style='margin:10px auto; display:block; background:#111827; border:2px solid #10B981; border-radius:12px;'>"
                             "  <path d='M20,0 V120 M40,0 V120 M60,0 V120 M80,0 V120 M100,0 V120 M0,20 H120 M0,40 H120 M0,60 H120 M0,80 H120 M0,100 H120' stroke='#374151' stroke-width='0.5'/>"
                             "  <!-- 8 enteros central (2x4) -->"
                             "  <rect x='40' y='40' width='80' height='40' fill='#10B981' fill-opacity='0.3' stroke='#10B981' stroke-width='2.5'/>"
                             "  <!-- 8 mitades (puntas) -->"
                             "  <polygon points='40,40 40,20 60,40' fill='#10B981' fill-opacity='0.15' stroke='#10B981'/>"
                             "  <polygon points='60,40 60,20 80,40' fill='#10B981' fill-opacity='0.15' stroke='#10B981'/>"
                             "  <polygon points='80,40 80,20 100,40' fill='#10B981' fill-opacity='0.15' stroke='#10B981'/>"
                             "  <polygon points='100,40 100,20 120,40' fill='#10B981' fill-opacity='0.15' stroke='#10B981'/>"
                             "  <polygon points='40,80 40,100 60,80' fill='#10B981' fill-opacity='0.15' stroke='#10B981'/>"
            ...
            },
            {
                "enunciado": "¿Cuánto es 12 enteros más 2 mitades?<br/>"
                             "<svg width='260' height='260' viewBox='-15 -10 150 135' style='margin:10px auto; display:block; background:#111827; border:2px solid #10B981; border-radius:12px;'>"
                             "  <path d='M20,0 V120 M40,0 V120 M60,0 V120 M80,0 V120 M100,0 V120 M0,20 H120 M0,40 H120 M0,60 H120 M0,80 H120 M0,100 H120' stroke='#374151' stroke-width='0.5'/>"
                             "  <!-- 12 enteros central (3x4) -->"
                             "  <rect x='40' y='40' width='60' height='80' fill='#10B981' fill-opacity='0.3' stroke='#10B981' stroke-width='2.5'/>"
                             "  <!-- 2 mitades -->"
            ...
            },
            {
                "enunciado": "Si un polígono ocupa 5 enteros y 4 mitades, su área es:<br/>"
                             "<svg width='260' height='260' viewBox='-15 -10 150 135' style='margin:10px auto; display:block; background:#111827; border:2px solid #10B981; border-radius:12px;'>"
                             "  <path d='M20,0 V120 M40,0 V120 M60,0 V120 M80,0 V120 M100,0 V120 M0,20 H120 M0,40 H120 M0,60 H120 M0,80 H120 M0,100 H120' stroke='#374151' stroke-width='0.5'/>"
                             "  <!-- 5 enteros vertical (1x5) -->"
                             "  <rect x='60' y='20' width='20' height='100' fill='#10B981' fill-opacity='0.3' stroke='#10B981' stroke-width='2.5'/>"
                             "  <!-- 4 mitades laterales -->"
                             "  <polygon points='60,40 40,60 60,60' fill='#10B981' fill-opacity='0.15' stroke='#10B981'/>"
        ...
        (4, 1): [
            ...
            },
            {
                "enunciado": "Si la escala es 1 u = 5 km, y viajas una distancia de 6 u en el mapa, ¿cuál es la distancia real?<br/>"
                             ...
                             "  <rect x='70' y='15' width='20' height='8' fill='#000'/>"
            ...
            },
            {
                "enunciado": "Escala 1 u = 2 m. Un árbol mide 15 u de altura en el plano. ¿Cuál es su altura real?<br/>"
                             ...
                             "  <!-- Regla vertical -->"
                             "  <line x1='75' y1='15' x2='75' y2='65' stroke='#FFF' stroke-width='1.5'/>"
