"""
Schemas Pydantic — Fase 6: Cubos Unitarios y Razonamiento
=============================================================
Schemas exclusivos de los módulos de Fase 6. No modifica ni reemplaza
...
class Fase6AlternativaOut(BaseModel):
...
class Fase6PreguntaParaAlumno(BaseModel):
    ...
    alternativas: Optional[List[Fase6AlternativaOut]] = None
    ...
    payload_tokenizado: Optional[List[Fase6Token]] = None
...
class Fase6ResponderPregunta(BaseModel):
...
class Fase6ResultadoRespuesta(BaseModel):
...
class Fase6NivelInfo(BaseModel):
...
class Fase6DesafioInfo(BaseModel):
...
class Fase6ModuloInfo(BaseModel):
    ...
    niveles: List[Fase6NivelInfo] = []
    desafios: List[Fase6DesafioInfo] = []
...
class Fase6InteractivoOut(BaseModel):
...
class Fase6EjemploOut(BaseModel):
    """Un ejemplo guiado dentro del contenido de teoría."""
    enunciado: str
    respuesta: str


class Fase6ContenidoLectura(BaseModel):
