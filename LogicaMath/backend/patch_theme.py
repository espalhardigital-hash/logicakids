...
files_to_patch = [
    r"D:\Antigravity\APP_Logica_Matematicas_kids\LogicaMath\backend\app\fase5\seed.py",
    r"D:\Antigravity\APP_Logica_Matematicas_kids\LogicaMath\backend\app\fase5\theory_examples.py",
    r"D:\Antigravity\APP_Logica_Matematicas_kids\LogicaMath\backend\app\fase5\svg_helpers.py"
]
