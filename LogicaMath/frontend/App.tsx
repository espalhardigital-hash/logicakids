...
import { UXFeedbackOverlay } from './components/common/UXFeedbackOverlay';


const Fase2GameScreenWrapper: React.FC<{ isEvaluatorMode: boolean; isAdmin?: boolean }> = ({ isEvaluatorMode, isAdmin }) => {
...
const Fase3GameScreenWrapper: React.FC<{ isEvaluatorMode: boolean; isAdmin?: boolean }> = ({ isEvaluatorMode, isAdmin }) => {
  const location = useLocation();
  const moduloId = location.state?.moduloId || 1;
  const nivelId = location.state?.nivelId || 1;
...
const Fase4GameScreenWrapper: React.FC<{ isEvaluatorMode: boolean; isAdmin?: boolean }> = ({ isEvaluatorMode, isAdmin }) => {
  const location = useLocation();
  const moduloId = location.state?.moduloId || 1;
  const nivelId = location.state?.nivelId || 1;
  const navigate = useNavigate();
  ...
  useEffect(() => {
    if (!location.state?.moduloId) {
      navigate('/welcome-fase4', { replace: true });
    }
  }, [location.state, navigate]);
...
const Fase5GameScreenWrapper: React.FC<{ isEvaluatorMode: boolean; isAdmin?: boolean }> = ({ isEvaluatorMode, isAdmin }) => {
  const location = useLocation();
  const moduloId = location.state?.moduloId || 1;
  const nivelId = location.state?.nivelId || 1;
  const navigate = useNavigate();
...
const Fase6GameScreenWrapper: React.FC<{ isEvaluatorMode: boolean; isAdmin?: boolean }> = ({ isEvaluatorMode, isAdmin }) => {
  const location = useLocation();
  const moduloId = location.state?.moduloId || 1;
  const nivelId = location.state?.nivelId || 1;
  const navigate = useNavigate();
...
const Fase7GameScreenWrapper: React.FC<{ isEvaluatorMode: boolean; isAdmin?: boolean }> = ({ isEvaluatorMode, isAdmin }) => {
  const location = useLocation();
  const moduloId = location.state?.moduloId || 1;
  const nivelId = location.state?.nivelId || 1;
  const navigate = useNavigate();
...
const Fase8GameScreenWrapper: React.FC<{ isEvaluatorMode: boolean; isAdmin?: boolean }> = ({ isEvaluatorMode, isAdmin }) => {
  const location = useLocation();
  const moduloId = location.state?.moduloId || 1;
  const nivelId = location.state?.nivelId || 1;
  const navigate = useNavigate();
...
const Fase9GameScreenWrapper: React.FC<{ isAdmin?: boolean }> = ({ isAdmin }) => {
...
const FaseGenericGameScreenWrapper: React.FC<{ isEvaluatorMode: boolean; isAdmin?: boolean }> = ({ isEvaluatorMode, isAdmin }) => {
  const location = useLocation();
  const moduloId = location.state?.moduloId || 1;
  const nivelId = location.state?.nivelId || 1;
  ...
  return (
    <UXFeedbackOverlay 
      fase={parseInt(faseId as string, 10)} 
      moduloId={parseInt(moduloId as string, 10)} 
      nivelId={parseInt(nivelId as string, 10)}
      isAdmin={isAdmin}
    >
      ...
      <div className="w-full max-w-4xl flex justify-center items-center relative z-10 min-h-[600px]">
        ...
        <Routes>
          ...
          <Route path="/fase2/play" element={
            currentUser ? (
              <Fase2GameScreenWrapper isEvaluatorMode={isEvaluatorMode} isAdmin={currentUser?.role === 'ADMIN'} />
            ) : (
              <Navigate to="/login" replace />
            )
          } />
          ...
          <Route path="/fase3/play" element={
            currentUser ? (
              <Fase3GameScreenWrapper isEvaluatorMode={isEvaluatorMode} isAdmin={currentUser?.role === 'ADMIN'} />
            ) : (
              <Navigate to="/login" replace />
            )
          } />
          ...
          <Route path="/fase4/play" element={
            currentUser ? (
              <Fase4GameScreenWrapper isEvaluatorMode={isEvaluatorMode} isAdmin={currentUser?.role === 'ADMIN'} />
            ) : (
              <Navigate to="/login" replace />
            )
          } />
          ...
          <Route path="/fase5/play" element={
            currentUser ? (
              <Fase5GameScreenWrapper isEvaluatorMode={isEvaluatorMode} isAdmin={currentUser?.role === 'ADMIN'} />
            ) : (
              <Navigate to="/login" replace />
            )
          } />
          ...
          <Route path="/fase6/play" element={
            currentUser ? (
              <Fase6GameScreenWrapper isEvaluatorMode={isEvaluatorMode} isAdmin={currentUser?.role === 'ADMIN'} />
            ) : (
              <Navigate to="/login" replace />
            )
          } />
          ...
          <Route path="/fase7/play" element={
            currentUser ? (
              <Fase7GameScreenWrapper isEvaluatorMode={isEvaluatorMode} isAdmin={currentUser?.role === 'ADMIN'} />
            ) : (
              <Navigate to="/login" replace />
            )
          } />
          ...
          <Route path="/fase8/play" element={
            currentUser ? (
              <Fase8GameScreenWrapper isEvaluatorMode={isEvaluatorMode} isAdmin={currentUser?.role === 'ADMIN'} />
            ) : (
              <Navigate to="/login" replace />
            )
          } />
          ...
          <Route path="/fase/9/game/:moduloId/:nivelId" element={
            currentUser ? (
              <Fase9GameScreenWrapper isAdmin={currentUser?.role === 'ADMIN'} />
            ) : (
              <Navigate to="/login" replace />
            )
          } />
          ...
          <Route path="/fase/play" element={
            currentUser ? (
              <FaseGenericGameScreenWrapper isEvaluatorMode={isEvaluatorMode} isAdmin={currentUser?.role === 'ADMIN'} />
            ) : (
              <Navigate to="/login" replace />
            )
          } />
