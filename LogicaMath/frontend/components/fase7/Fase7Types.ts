 ...
 * Espeja exactamente los schemas Pydantic del backend (fase7/schemas.py)
 */
...
export interface Fase7PasoCadenado {
  titulo: string;
  descripcion: string;
...
export interface Fase7Pregunta {
  ...
  payload_tokenizado?: Fase7Token[];
  pasos_encadenados?: Fase7PasoCadenado[];
