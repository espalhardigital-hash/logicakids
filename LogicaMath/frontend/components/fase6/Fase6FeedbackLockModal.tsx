...
import type { Fase6AnswerResult } from './Fase6Types';
...
export const Fase6FeedbackLockModal: React.FC<Props> = ({ resultado, moduleColor, onContinue }) => {
  ...
  return (
    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="f6-feedback-overlay" style={{ zIndex: 1200 }} role="dialog" aria-modal="true" aria-labelledby="fase6-feedback-title">
      <motion.section initial={{ scale: 0.96, y: 16 }} animate={{ scale: 1, y: 0 }} className="f6-feedback-card glass-card" style={{ maxWidth: '620px', width: '92%', padding: '28px', borderTop: `6px solid ${moduleColor}` }}>
        <div className="flex items-center gap-3 mb-4">
          ...
          <div>
            <h2 id="fase6-feedback-title" className="text-xl font-black text-white">Veamos cómo se resolvía</h2>
