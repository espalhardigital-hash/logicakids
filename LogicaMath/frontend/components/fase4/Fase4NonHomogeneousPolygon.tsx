...
import { NonHomogeneousSector } from './Fase4Types';

interface Fase4NonHomogeneousPolygonProps {
...
export const Fase4NonHomogeneousPolygon: React.FC<Fase4NonHomogeneousPolygonProps> = ({
  sectors,
  viewBox = "0 0 100 100",
  selectedIds,
  onToggleSector,
...
export default Fase4NonHomogeneousPolygon;
