...
export const WelcomeScreenPhase5: React.FC<Props> = ({
  ...
  const [dashboard, setDashboard] = useState<Fase5Dashboard | null>(null);
  const [loading, setLoading]   = useState(true);
  const [error, setError]       = useState<string | null>(null);
  const [selectedModule, setSelectedModule] = useState<Fase5ModuloInfo | null>(null);
  ...
  const handleModuleClick = (modulo: Fase5ModuloInfo) => {
...
export default WelcomeScreenPhase5;
