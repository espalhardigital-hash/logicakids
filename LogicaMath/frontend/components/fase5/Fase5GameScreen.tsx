  ...
  return (
    ...
    >
      ...
      >
        ...
        <button
          className="f5-mixed-challenge-btn w-full"
          onClick={onClose}
          style={{
  ...
  return (
    ...
    >
      ...
      >
        ...
        <motion.button
          variants={itemVariants}
          className="f5-mixed-challenge-btn w-full py-4 text-xl"
          onClick={onClose}
          style={{
...
export const Fase5GameScreen: React.FC<{ isEvaluatorMode?: boolean }> = ({ isEvaluatorMode }) => {
  ...
  const loadNextQuestion = useCallback(async (reload: boolean = false) => {
    ...
    try {
      const q = await getFase5Question(moduloId, nivelId, reload);
      
      // Test de verificación 1.1: Clasificación de pregunta de colección discreta
      const esDiscreta = isDiscreteQuestion(q.enunciado);
      console.log(`[Fase5GameScreen] Pregunta cargada: "${q.enunciado}". ¿Es discreta? ${esDiscreta}`);
  ...
  useEffect(() => {
    const handleSync = (e: Event) => {
      console.log('🔄 [Fase5GameScreen] Sync request received from admin. Reloading question...');
      loadNextQuestion(true);
    };
    ...
    return (
      <div className="f5-screen-wrapper">
        <div className="f5-loading-spinner-wrap">
          <div className="f5-spinner-element" style={{ borderTopColor: moduleColor }} />
  ...
  if (errorMsg) {
    return (
      <div className="f5-screen-wrapper" style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center' }}>
        <div className="glass-card" style={{ padding: '40px', textAlign: 'center', maxWidth: '500px', borderTop: '6px solid #EF4444' }}>
          ...
          <button 
            onClick={() => navigate('/welcome-fase5')} 
  ...
  return (
    <div className="f5-screen-wrapper" style={{ ['--module-accent' as any]: moduleColor }}>
      ...
      <header className="f5-game-header-modern">
        <button 
          className="f5-nav-back-btn text-red-400 border-red-500/20" 
          onClick={() => navigate('/welcome-fase5')}
        >
          <ArrowLeft size={18} />
        </button>
        ...
        <div className="f5-header-right-group">
          ...
          <div className="f5-header-badge-pill">
            <span className="f5-badge-module" style={{ color: moduleColor }}>
            ...
            {timer !== null && (
              <>
                <span className="f5-badge-divider">|</span>
                <span className="f5-badge-timer" style={{ color: timer <= 5 ? '#EF4444' : '#ffffff' }}>
                  {timer}S
                </span>
              </>
            )}
        ...
        <div className="f5-full-width-progress-bar">
          <div 
            className="f5-full-width-progress-fill"
            style={{ 
              width: `${barWidth}%`, 
        ...
        {timer !== null && (
          <div className="f5-timer-progress-bar">
            <div 
              className="f5-full-width-progress-fill" 
              style={{ 
        ...
        {isInteractiveLayout ? (
              ...
              {!isChallenge && (
                <div className="f5-scores-container max-w-[400px] mt-8 w-full">
                  <div className="f5-score-box correct">
                    <span className="f5-score-label">CORRECTAS</span>
                    <span className="f5-score-value">{progreso.aciertos}</span>
                  </div>
                  <div className="f5-score-box incorrect">
                    <span className="f5-score-label">ERRORES</span>
                    <span className="f5-score-value">{progreso.intentos - progreso.aciertos}</span>
                  </div>
                </div>
              )}
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center w-full max-w-4xl">
            ...
            <div className="flex flex-col items-center justify-center">
              ...
              {!isChallenge && (
                <div className="f5-scores-container max-w-[400px]">
                  <div className="f5-score-box correct">
                    <span className="f5-score-label">CORRECTAS</span>
                    <span className="f5-score-value">{progreso.aciertos}</span>
                  </div>
