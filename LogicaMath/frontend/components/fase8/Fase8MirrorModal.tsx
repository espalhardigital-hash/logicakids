...
import type { Fase8Pregunta, Fase8AnswerResult, Fase8AnswerResult as ResultType } from './Fase8Types';
import { submitFase8Answer } from './Fase8Service';

interface Props {
  pregunta: Fase8Pregunta;
  moduleColor: string;
  onClose: (result?: Fase8AnswerResult) => void;
  lastCorrectAnswer?: string;
  lastQuestionEnunciado?: string;
  lastWrongAnswer?: string;
}

export const Fase8MirrorModal: React.FC<Props> = ({ 
  pregunta, 
  moduleColor, 
  onClose,
  lastCorrectAnswer,
  ...
  const handleSubmit = async () => {
    ...
    try {
      const result = await submitFase8Answer({
