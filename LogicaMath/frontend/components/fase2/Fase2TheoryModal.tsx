            ...
            {currentSlide?.type === 'intro' && (
              ...
              >
                {readingData.parrafos.map((p, idx) => (
                  <p key={idx} className="f2-reading-p" dangerouslySetInnerHTML={{ __html: formatContent(p) }} />
                ))}
                    ...
                    <div className="f2-dict-grid">
                      {Object.entries(readingData.diccionario).map(([termino, definicion], idx) => (
                        <div key={idx} className="f2-dict-card" style={{ borderColor: `${moduleColor}55` }}>
                          <div className="f2-dict-term" style={{ color: moduleColor }} dangerouslySetInnerHTML={{ __html: formatContent(termino) }} />
                          <div className="f2-dict-def" dangerouslySetInnerHTML={{ __html: formatContent(definicion as string) }} />
                        </div>
                      ))}
                    </div>
                  </div>
                  ...
                  <div className="f2-reading-examples">
                    ...
                    {currentSlide.data.map((ex: any, idx: number) => (
                      <div key={idx} className="f2-example-box">
                        <div className="f2-ex-q" dangerouslySetInnerHTML={{ __html: formatContent(ex.enunciado) }} />
                        {ex.pasos ? (
                          <div className="f2-ex-steps">
                           ...
                           <div className="f2-ex-legacy">→ <span style={{ color: moduleColor }} dangerouslySetInnerHTML={{ __html: formatContent(ex.respuesta) }} /></div>
                        )}
                      </div>
                    ))}
                  </div>
