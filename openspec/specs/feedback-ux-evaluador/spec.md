# feedback-ux-evaluador

Esta especificación describe la capacidad de recolectar, estructurar, persistir y administrar feedbacks y mejorías de UX en caliente realizadas por evaluadores autorizados en los juegos de LógicaKids.

## Purpose
Proveer un canal directo de comunicación entre los revisores pedagógicos/evaluadores de QA y el equipo de desarrollo (o agentes como Antigravity), permitiendo referenciar comentarios de implementación directamente a elementos visuales específicos de la interfaz de juego.
